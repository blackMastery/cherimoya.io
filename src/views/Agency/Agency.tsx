    ...
    <>
      ...
      >
        <Box
          ...
          sx={styles(
            'https://images.unsplash.com/photo-1613325436249-c90b7a608248?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80',
          )}
        />
        <Container>
          <Goby />
